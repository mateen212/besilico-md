...
const testimonials = [
  { name: 'Alessandro Romano', comment: "Like dining in my nonna's kitchen in Tuscany. Pure magic.", rating: 5 },
  { name: 'Emma Rossi', comment: 'Every dish tells a story. The passion is palpable in every bite.', rating: 5 },
  { name: 'Marco Bianchi', comment: 'Simply the most authentic Italian experience outside of Italy.', rating: 5 },
];
    ...
    <div className="overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative h-screen overflow-hidden">
        <motion.div style={{ y }} className="absolute inset-0">
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1559339352-11d035aa65de?w=1920&h=1080&fit=crop&auto=format"
        ...
        <motion.div style={{ opacity }} className="relative h-full flex items-center justify-center text-center px-6">
          <div className="max-w-4xl">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.3 }}>
              <h1 className="font-['Great_Vibes'] text-6xl md:text-8xl lg:text-9xl mb-4" style={{ color: 'var(--brand-gold)' }}>
                Basilico
              </h1>
              <p className="text-sm md:text-base tracking-[0.4em] uppercase mb-8" style={{ fontFamily: 'Inter', color: '#F8F3EA' }}>
                by Sara
              </p>
            </motion.div>
            ...
            <motion.p
              ...
              style={{ fontFamily: 'Cormorant Garamond', color: '#F8F3EA', fontStyle: 'italic' }}
            >
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.9 }}>
              <Link
                ...
                style={{ borderColor: 'var(--brand-gold)', backgroundColor: 'var(--brand-gold)', color: '#1C1C1C', fontFamily: 'Inter', fontWeight: 500 }}
                onMouseEnter={(e) => {
        ...
        >
          <div className="w-6 h-10 border-2 rounded-full flex justify-center pt-2" style={{ borderColor: 'var(--brand-gold)' }}>
            <motion.div
              animate={{ y: [0, 12, 0] }}
      ...
      <section className="py-24 lg:py-32" style={{ backgroundColor: 'var(--brand-bg)' }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            <p className="text-xs tracking-[0.4em] uppercase mb-4" style={{ fontFamily: 'Inter', color: 'var(--brand-gold)' }}>
              Chef's Selection
            </p>
            <h2 className="text-4xl md:text-5xl lg:text-6xl mb-4" style={{ fontFamily: 'Playfair Display', color: 'var(--brand-text)' }}>
              Signature Creations
            </h2>
            <p className="text-lg max-w-2xl mx-auto" style={{ fontFamily: 'Inter', color: 'var(--brand-text-muted)' }}>
              ...
              >
                <div className="relative overflow-hidden rounded-2xl mb-4 aspect-[3/4]">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 text-white transform translate-y-full group-hover:translate-y-0 transition-transform duration-500">
                    <p className="text-sm opacity-90" style={{ fontFamily: 'Inter' }}>{dish.description}</p>
                  </div>
                </div>
                <h3 className="text-xl mb-2" style={{ fontFamily: 'Playfair Display', color: 'var(--brand-text)' }}>
                  {dish.name}
                </h3>
                <p className="text-lg" style={{ fontFamily: 'Inter', fontWeight: 500, color: 'var(--brand-olive)' }}>
                  {dish.price}
                </p>
              </motion.div>
            ))}
          ...
          >
            <Link
              ...
              style={{ fontFamily: 'Inter', fontWeight: 500, color: 'var(--brand-olive)' }}
            >
              Explore Full Menu
              <ArrowRight size={20} />
            </Link>
      ...
      <section className="py-24 lg:py-32" style={{ backgroundColor: 'var(--brand-surface)' }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div>
                <p className="text-sm tracking-[0.3em] uppercase mb-3" style={{ fontFamily: 'Inter', color: 'var(--brand-gold)' }}>
                  Our Heritage
                </p>
                <h2 className="text-4xl md:text-5xl mb-6" style={{ fontFamily: 'Playfair Display', color: 'var(--brand-text)' }}>
              ...
              <p className="text-lg leading-relaxed" style={{ fontFamily: 'Inter', color: 'var(--brand-text-muted)' }}>
                Born in the sun-drenched hills of Tuscany, Chef Sara brings three generations of family recipes to life. Each dish is a tribute to her grandmother's kitchen, where she first learned that cooking is an act of love.
              </p>
              <p className="text-lg leading-relaxed" style={{ fontFamily: 'Inter', color: 'var(--brand-text-muted)' }}>
                At Basilico, we honor the slow food movement—sourcing from local artisans, hand-rolling our pasta daily, and letting flavors develop with patience and care.
              </p>
              <Link
                to="/about"
      ...
      {/* Values */}
      <section className="py-24 lg:py-32" style={{ backgroundColor: 'var(--brand-olive)' }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl md:text-5xl mb-4" style={{ fontFamily: 'Playfair Display', color: '#F8F3EA' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { icon: Award, title: 'Artisan Quality', description: 'Every ingredient sourced from trusted Italian producers and local artisans' },
              { icon: Heart, title: 'Made with Love', description: 'Recipes passed down through generations, prepared with genuine passion' },
              { icon: Users, title: 'Family Experience', description: 'Warm hospitality that makes you feel like part of our famiglia' },
            ].map((value, index) => (
              <motion.div
                key={value.title}
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                <div className="w-16 h-16 mx-auto mb-6 rounded-full border-2 flex items-center justify-center" style={{ borderColor: 'var(--brand-gold)' }}>
                  <value.icon size={32} style={{ color: 'var(--brand-gold)' }} />
                </div>
                <h3 className="text-2xl mb-4" style={{ fontFamily: 'Playfair Display', color: '#F8F3EA' }}>{value.title}</h3>
                <p className="text-base opacity-80 leading-relaxed" style={{ fontFamily: 'Inter', color: '#F8F3EA' }}>{value.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 lg:py-32" style={{ backgroundColor: 'var(--brand-bg)' }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl md:text-5xl mb-4" style={{ fontFamily: 'Playfair Display', color: 'var(--brand-text)' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((t, index) => (
              ...
              >
                ...
                <p className="text-lg mb-6 italic leading-relaxed" style={{ fontFamily: 'Cormorant Garamond', color: 'var(--brand-text)', fontSize: '1.2rem' }}>
                  "{t.comment}"
                </p>
                <p className="text-sm tracking-wider uppercase" style={{ fontFamily: 'Inter', fontWeight: 500, color: 'var(--brand-olive)' }}>
                  {t.name}
                </p>
              </motion.div>
            ))}
      ...
      <section className="relative py-32 lg:py-40 overflow-hidden">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl mb-6" style={{ fontFamily: 'Playfair Display', color: '#F8F3EA' }}>
            Ready for an Unforgettable<br />Italian Experience?
          </h2>
          <p className="text-lg md:text-xl mb-12 opacity-90" style={{ fontFamily: 'Inter', color: '#F8F3EA' }}>
