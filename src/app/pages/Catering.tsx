...
const packages = [
  {
    ...
    items: [
      'Selection of 5 traditional Italian appetizers',
      'Bruschetta station with fresh toppings',
      'Italian charcuterie and cheese board',
      'Seasonal vegetable antipasti',
      'Prosecco and wine service',
    ],
  },
  {
    ...
    items: [
      'Antipasto course with 3 selections',
  ...
  },
  {
    ...
    items: [
      'Welcome aperitivo with Prosecco',
      'Gourmet antipasto trio',
      'Fresh pasta course',
      'Palate cleanser',
      'Premium main course (surf & turf)',
      'Handcrafted dessert buffet',
      'Premium wine and champagne',
      'Late-night Italian coffee bar',
    ],
  },
];
    ...
    <div className="overflow-x-hidden">
      ...
      <section className="relative h-[50vh] lg:h-[60vh] overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/40 to-[#F8F3EA]" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <p
              ...
              style={{ fontFamily: 'Inter', color: '#1C1C1C' }}
            >
              Carefully curated menus designed to delight your guests
            </p>
          </motion.div>
          ...
          >
            <p
              ...
              style={{ fontFamily: 'Inter', color: '#1C1C1C' }}
            >
              All packages can be customized to accommodate dietary restrictions and preferences
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { icon: '🎉', title: 'Celebrations', desc: 'Birthdays, anniversaries & more' },
              { icon: '💼', title: 'Corporate', desc: 'Professional events & meetings' },
              { icon: '🏠', title: 'Private Dining', desc: 'Intimate gatherings at home' },
            ].map((event, index) => (
              <motion.div
                key={event.title}
                initial={{ opacity: 0, y: 30 }}
          ...
          {!isSubmitted ? (
            ...
            >
              <div className="text-center mb-12">
                <ChefHat size={48} className="mx-auto mb-6" style={{ color: '#556B2F' }} />
                <h2
              ...
              <div className="rounded-2xl shadow-lg p-8 lg:p-12" style={{ backgroundColor: '#F8F3EA' }}>
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        type="text"
                        className="w-full px-4 py-3 rounded-xl border-2 transition-all duration-300 focus:outline-none bg-white"
                        style={{
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 rounded-xl border-2 transition-all duration-300 focus:outline-none bg-white"
                        style={{
                          borderColor: errors.eventType ? '#6B1F2B' : 'rgba(85, 107, 47, 0.2)',
                          fontFamily: 'Inter',
                        }}
                        onFocus={(e) => {
                          if (!errors.eventType) e.currentTarget.style.borderColor = '#556B2F';
                        }}
                        onBlur={(e) => {
                          if (!errors.eventType) e.currentTarget.style.borderColor = 'rgba(85, 107, 47, 0.2)';
                        }}
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl border-2 transition-all duration-300 focus:outline-none bg-white"
                        style={{
                          borderColor: errors.eventDate ? '#6B1F2B' : 'rgba(85, 107, 47, 0.2)',
                          fontFamily: 'Inter',
                        }}
                        onFocus={(e) => {
                          if (!errors.eventDate) e.currentTarget.style.borderColor = '#556B2F';
                        }}
                        onBlur={(e) => {
                          if (!errors.eventDate) e.currentTarget.style.borderColor = 'rgba(85, 107, 47, 0.2)';
                        }}
                      />
                      {errors.eventDate && (
                        <p className="text-sm mt-1" style={{ color: '#6B1F2B', fontFamily: 'Inter' }}>
                  ...
                  <div>
                    <label
                      ...
                      style={{ fontFamily: 'Inter', color: '#1C1C1C' }}
                    >
                      <MapPin size={16} style={{ color: '#556B2F' }} />
                      Event Location *
                    </label>
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border-2 transition-all duration-300 focus:outline-none bg-white"
                      style={{
                        borderColor: errors.location ? '#6B1F2B' : 'rgba(85, 107, 47, 0.2)',
                        fontFamily: 'Inter',
                      }}
                      onFocus={(e) => {
                        if (!errors.location) e.currentTarget.style.borderColor = '#556B2F';
                      }}
                      onBlur={(e) => {
                        if (!errors.location) e.currentTarget.style.borderColor = 'rgba(85, 107, 47, 0.2)';
                      }}
                    />
                    {errors.location && (
                      <p className="text-sm mt-1" style={{ color: '#6B1F2B', fontFamily: 'Inter' }}>
                  ...
                  <div>
                    ...
                    <textarea
                      {...register('message')}
                      rows={4}
                      placeholder="Menu preferences, dietary restrictions, budget range, or any other details..."
                      className="w-full px-4 py-3 rounded-xl border-2 transition-all duration-300 focus:outline-none resize-none bg-white"
                      style={{
                        borderColor: 'rgba(85, 107, 47, 0.2)',
                        fontFamily: 'Inter',
                      }}
